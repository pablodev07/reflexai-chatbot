    ...
    <main className="homeContainer flex flex-col xl:flex-row h-screen">
      ...
      <section className="flex flex-1 flex-col justify-around px-5 lg:px-20 py-10">
        ...
        <div className="button-container flex flex-col flex-1 gap-6 lg:items-center">
          <a href="/chat"><button className="w-full lg:w-[20rem] bg-primary rounded-full py-[0.575rem] lg:py-[0.875rem] px-[1.5625rem] font-bold text-white transition ease-in-out transition ease-in-out border-2 border-transparent hover:bg-white hover:text-dark hover:border-primary">
            Chat with us
          </button></a>
          <button className="w-full lg:w-[20rem] rounded-full py-[0.575rem] lg:py-[0.875rem] px-[1.5625rem] border-2 border-solid border-primary font-bold text-dark transition ease-in-out hover:bg-primary hover:text-white">
            Admin Panel
          </button>
        </div>
      </section>
